...
let newFrame = (timestamp) => {
  ...
  let boostMultiplerEffective = boostMultiplier > 2 ? 2 : boostMultiplier;
  console.log("effective boostMultiplier:", boostMultiplerEffective);
  //render:
  ...
  localPlayer.loc = vec.add(
    ...
    vec.normalized(boostDir, boostMultiplerEffective * walkspeed * dt)
  );
  // console.log("loc: ", loc);
...
},{"./debug":42,"_process":5,"dup":24}],42:[function(require,module,exports){
...
arguments[4][24][0].apply(exports,arguments)
},{"./debug":48,"_process":5,"dup":24}],48:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
},{"dup":25,"ms":49}],49:[function(require,module,exports){
arguments[4][26][0].apply(exports,arguments)
